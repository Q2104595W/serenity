...
public class OrderCoffeeSteps {
    ...
    public void cathy_is_metres_from_the_coffee_shop(Integer distanceInMetres) {
        //System.out.println("Meters = " + distanceInMetres);
    ...
    @Then("Barry should know the order is (.*)$")
    public void barry_should_know_the_order_is_Urgent(OrderStatus expectedStatus) {
